      ...
      {appPages
        ...
        .map(({ path, name, icon }, index) => (
          <Navbar.Link
            ...
            as={NavLink}
            to={path}
            className={({ isActive }) => isActive ? "text-gray-900 border-indigo-500" :  "flex flex-col items-center justify-center text-sm text-gray-600 py-3 focus:outline-none focus:text-gray-900 focus:border-indigo-500"}
          >
            {icon}
